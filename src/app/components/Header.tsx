  ...
  return (
    <>
      <header className="max-w-[1440px] mx-auto md:h-[66px] md:px-10 px-5 sticky top-0 md:static backdrop-blur-sm z-20">
        ...
        <Link
       className="flex justify-center items-center cursor-pointer rounded-md p-2"
  href="/carts"
>
  <div className=" flex justify-center items-center bg-blue-600 px-2 py-1 rounded-md">
    <MdOutlineShoppingCart className="text-white" />
    <span className=" top-0 right-0 flex justify-center items-center w-[20px] h-[25px] text-center rounded-md text-white font-bold text-[15px]">
      {addCart.length}
    </span>
  </div>
</Link>
